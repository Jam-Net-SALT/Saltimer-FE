...
import { Group, Text, useMantineTheme, MantineTheme, Image, Grid, Button, Center, Space, TextInput, Loader } from '@mantine/core';
import { Dropzone, DropzoneStatus, IMAGE_MIME_TYPE } from '@mantine/dropzone';
import { AuthContext, AuthContextInterface } from "../../services/AuthProvider";
import { getIconColor, ImageUploadIcon, userInitialValues, userValidationRules, userErrorMessages } from './helpers'
...
export default function FileUploader() {
    ...
    const dropzoneChildren = (status: DropzoneStatus, theme: MantineTheme) => (
        <Group position="center" spacing="xl" style={{ minHeight: 220, pointerEvents: 'none' }}>
            <ImageUploadIcon status={status} style={{ color: getIconColor(status, theme) }} size={100} />
